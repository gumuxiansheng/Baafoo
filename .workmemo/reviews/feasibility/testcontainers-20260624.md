...
**场景描述**: 将现有的 `testing/4_E2ETest/enterprise/` 下的手工 Docker Compose 测试，改造为基于 Testcontainers 的自动化测试。
...
| 企业级测试基础 | [testing/4_E2ETest/enterprise/common/docker-compose.base.yml](file:///c:/Dev/Projects/Baafoo/testing/4_E2ETest/enterprise/common/docker-compose.base.yml) | 企业级测试基础编排 |
| Kafka 企业级测试 | [testing/4_E2ETest/enterprise/kafka/docker-compose.yml](file:///c:/Dev/Projects/Baafoo/testing/4_E2ETest/enterprise/kafka/docker-compose.yml) | Kafka 测试编排 |
