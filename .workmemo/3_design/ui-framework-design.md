...
> **文档状态**：📦 存档（v1.5）  
> **对齐状态**：⚠️ 过时 — PRD 已迭代至 v2.4，且 `6_dev-notes/23-web-console-ui.md` 记录了前端大更新，本文档与实现已脱节  
> **关联文档**：[概念设计说明书](../1_concepts/baafoo-concept-design.md) | [产品需求文档 v2.4](../2_prd/baafoo-prd.md)  
> **目标读者**：前端开发工程师、UI 设计师  
