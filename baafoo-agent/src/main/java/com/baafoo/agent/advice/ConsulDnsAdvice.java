...
/**
 * Byte Buddy Advice for java.net.InetAddress#getByName(String).
 *
 ...
 * <p>Logic:
 * <pre>
 *   String host = getByName argument
    ...
    public static void onGetByName(
        ...
        try {
            ...
            if (routeResult.matched) {
                ...
                log.debug("Consul DNS: {} → {} (rule: {})", host, stubHost, routeResult.rule.getName());
            }
        } catch (Exception e) {
            log.error("Error in ConsulDnsAdvice: {}", e.getMessage());
